...
inherit autotools
FILESEXTRAPATHS:prepend := "${THISDIR}/llvm:"
RDEPENDS:${PN} += "ncurses ncurses-libtinfo libgcc libstdc++ glibc"
...
INSANE_SKIP:${PN} += "ldflags split-strip arch staticdev file-rdeps"
FILES:${PN} += "${libdir}/llvm_build_dir/"
